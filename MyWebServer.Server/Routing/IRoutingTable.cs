...
namespace MyWebServer.Server.Routing
{
    public interface IRoutingTable
    {
        ...
        IRoutingTable Map(string url, HttpMethod method, HttpResponse response); //ако се ползва само .Map -> трябва да се подаде метода ръчно; ако не -> следва да се позлва .MapGet, .MapPost и тн. каквито други методи имаме;
